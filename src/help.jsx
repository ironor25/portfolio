...
const BlockchainPortfolio = () => {
  ...
  const skills = [
    {
      category: "Blockchain",
      items: ["Solidity", "Smart Contracts", "Ether.js", "Hardhat", "Genache", "ERC Standards", "Ethereum"]
    },
    {
      category: "Frontend",
      items: ["React", "TailwindCSS", "JavaScript", "HTML/CSS", "Python"]
    },
    {
      category: "Backend",
    ...
    },
    {
      ...
      items: ["MySQL", "Pandas", "Matplotlib", "Numpy"]
    },
    {
      category: "Soft Skills",
      items: ["Leadership", "Get The Work done", "Resilient", "Problem solver"]
    },
    {
      category: "Non-technical Skills",
      items: ["Stock Trading", "Stock Research", "Crypto Trading", "Research on MemeCoin", "Finance Research", "Technical and Fundamental Analysis", "Price Action"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 text-gray-100">
      ...
      <nav className="fixed w-full bg-gray-900/80 backdrop-blur-sm z-50">
        <div className="max-w-7xl mx-auto p-5 py-4 flex justify-between items-center">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-4 pt-16">
        <div className="flex flex-col md:flex-row items-center">
          <div className="text-center md:text-left max-w-4xl md:mr-10">
            ...
            <p className="text-xl md:text-3xl text-gray-300 mt-4">
              Blockchain Developer & Crypto Researcher
            </p>
            <div className="flex space-x-4 mt-6 justify-center md:justify-start">
              <a href="#projects" className="bg-blue-500 hover:bg-blue-600 px-6 py-3 rounded-lg transition-colors">View Projects</a>
              <a href="https://drive.google.com/file/d/1dMGcWC3bJvqr9VM158Ad3KlPi8WsAMy3/view?usp=sharing" target="_blank" className="border border-blue-500 hover:bg-blue-500/10 px-6 py-3 rounded-lg transition-colors">My CV</a>
            </div>
          </div>
