      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-4 pt-16">
        ...
        <div className="max-w-4xl text-left mr-60">
          ...
          <div className="flex space-x-9 mt-28">
            ...
            <a href="https://drive.google.com/file/d/1lnl6K7bNFJV7-iEJz10BcWsohqi6ulPI/view?usp=sharing" target='_blank' className="border border-blue-500 hover:bg-blue-500/10 px-6 py-3 rounded-lg transition-colors">
              My CV
            </a>
          </div>
        </div>
